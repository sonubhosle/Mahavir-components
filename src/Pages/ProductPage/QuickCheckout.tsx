...
const QuickCheckout: React.FC = () => {
    ...
    return (
        <div className="border border-gray-200 rounded-lg p-4 w-full   mt-8">
            {/* Header */}
            <div
            ...
            >
                <div className="flex items-center gap-2 font-semibold text-black">
                    <span className="font-bold text-2xl">⚡ Quick Checkout</span>
                </div>
                <p>{isOpen ? <IoIosClose size={30} /> : <IoChevronDownSharp size={25} />}</p>
            </div>
            <div className="mt-2 text-sm text-gray-600">
                <p>
                    Choose your center stone’s origin & size and let our experts
                    handpick the perfect diamond for you
                </p>
                <a href="#" className="text-sm font-semibold text-black underline mt-2 inline-block" >
                    Let's Do It
                </a>
            </div>
                ...
                <div className="mt-2 text-sm text-gray-600 flex gap-3 rounded">
                    <div className="flex flex-nowrap overflow-auto gap-1  md:gap-2 md:justify-between">
                        ...
                        <button type="button" className="flex gap-1 cursor-pointer items-center whitespace-nowrap rounded-md pl-3 pr-4 py-2 text-1.5sm leading-tight flex-1 justify-center border border-gray-200 ">
                            ...
                            <span className="text-black text-1.5sm leading-tight">Natural Diamonds</span></button></div>
                </div>
                <div className="flex gap-4 mt-6">
                    <div className="grid grid-cols-5 gap-4  ">
                        <div className="border border-gray-200 w-12 rounded h-10  p-2 text-center">1.0</div>
                        <div className="border border-gray-200  w-12 rounded h-10  p-2 text-center">1.5</div>
                        <div className="border border-gray-200  w-12 rounded h-10  p-2 text-center">2.0</div>
                        <div className="border border-gray-200  w-12 rounded h-10  p-2 text-center">2.5</div>
                        <div className="border border-gray-200  w-12 rounded h-10  p-2 text-center">3.0</div>
                    </div>
                    <button className="border border-gray-200  text-gray-900 rounded px-4 py-2 w-[160px]">See Full Inventory</button>
